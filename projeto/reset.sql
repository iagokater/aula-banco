...
ALTER TABLE LOCALIZACOES
    ADD FOREIGN KEY (opr_id) REFERENCES OPERACOES_MAQUINARIO(id_opr);

ALTER TABLE OPERACOES_MAQUINARIO
    ADD FOREIGN KEY (user_id) REFERENCES USUARIOS(id_user),
    ADD FOREIGN KEY (maq_id) REFERENCES MAQUINAS(id_maq);
